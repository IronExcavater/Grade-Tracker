...
public class AppController extends Controller {
    ...
    private void loadContent(Tab tab) {
        ...
        try {
            Class<?> tabClass = Class.forName("ironbyte.gradetracker.controller.%sController".formatted(tab.getText()));
            Controller controller = (Controller) tabClass.getDeclaredConstructor(Stage.class).newInstance(stage);
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/ironbyte/gradetracker/view/%s-view.fxml"
