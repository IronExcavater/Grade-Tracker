...
import ironbyte.gradetracker.model.action.ImportAction;
...
public class DataManager {
    ...
    private static final File SAVE_FILE = new File(System.getProperty("user.dir"), "data.json");
    ...
    private static class DataAdapter implements JsonSerializer<Data<?>>, JsonDeserializer<Data<?>> {
        ...
        public Data<?> deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context) throws JsonParseException {
            ...
            try {
                Class<?> dataClass = Class.forName("ironbyte.gradetracker.model.data." + className);
